...
// is declared here is only what is this gallery's: the field specification
// (legacy DatabaseItem.vue's `objectData`, field for field), the photos in
// their order, the related tile, and the citation without a permalink, as
// legacy printed it. Every label is an entry name, written out so the check
...
// a language this gallery does not offer) they fall back to English, which
// is where legacy pinned them anyway.
//
